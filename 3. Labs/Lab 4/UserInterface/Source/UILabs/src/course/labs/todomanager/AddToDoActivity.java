	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//Intent result = new Intent("RESULT_ACTION");
				//ToDoItem.packageIntent(result, titleString, priority, status, fullDate);
				//result.putExtra(ToDoItem.TITLE, titleString);
				//result.putExtra(ToDoItem.STATUS, status);
				//result.putExtra(ToDoItem.PRIORITY, priority);
				//result.putExtra(ToDoItem.DATE, fullDate);
